...
@section('InputKeyModulo', 'active menu-open')
@section('InputKeyModulo.InputKeySubModulo', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>InputNameModulo</a></li>
<li class='active'>InputNameSubModulo</li>
@endsection

@php
	$model = 'InputNameModel';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('InputNameRoute.InputNameSubRoute.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="InputNameIcon"></i> InputNameSubModulo</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['InputNameRoute.InputNameSubRoute.index'], 
...
@section('scripts')
    <script src="{{ url('/js/InputNameRoute/InputNameSubRoute.js') }}"></script>
@endsection
