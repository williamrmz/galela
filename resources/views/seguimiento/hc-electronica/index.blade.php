...
@section('SE.HcElectronica', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Seguimiento</a></li>
<li class='active'>HC Electrónica</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('seguimiento.hc-electronica.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-male text-aqua"></i> HC Electrónica</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['seguimiento.hc-electronica.index'], 
...
@section('scripts')
    <script src="{{ url('/js/seguimiento/hc-electronica.js') }}"></script>
@endsection
