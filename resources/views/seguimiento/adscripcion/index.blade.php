...
@section('SE.Sadscripcion', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Seguimiento</a></li>
<li class='active'>Adscripción</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('seguimiento.adscripcion.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-folder-open text-orange"></i> Adscripción</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['seguimiento.adscripcion.index'], 
...
@section('scripts')
    <script src="{{ url('/js/seguimiento/adscripcion.js') }}"></script>
@endsection
