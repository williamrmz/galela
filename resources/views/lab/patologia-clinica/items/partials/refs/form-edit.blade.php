{{  Form::model($ref, ['route' => ['lab.refs.update', $ref->id_valor], 'method'=>'PUT', 'id'=>'ref-form','class'=>'row' ]) }}
    ...
    <div class="col-sm-12">
        <div class="pull-right">
            ...
            <button type="submit" class="btn btn-sm btn-primary refs-btn-store">ACTUALIZAR</button>
        </div>
    </div>
