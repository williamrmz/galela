        ...
        <tbody>
            <?php foreach($items as $key => $item): ?>
                ...
                <?php
                    ...
                    {
                        // dd($item);
                        $checked = $item->valorCheck==1? true: false;
                        $pendiente = $item->pendiente==1? 'Pendiente': '';
                        // if( $item->valorCheck==1 ){
                            echo "<tr>";
                                echo "<td style='padding-left:20px'>$item->nombreItem</td>";
                                echo "<td align='center'>$pendiente</td></tr>";
                            echo "<tr><td colspan='2' style='padding-left:20px'>";
                                ?> @if($checked) @include(PATH_PARTIALS.'antibiograma') @endif <?php
                            echo "</td></tr>";
                        // }
