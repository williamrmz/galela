...
@section('FE.FactReembolsos', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Facturación</a></li>
<li class='active'>Reembolsos</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('facturacion.reembolsos.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-money text-green"></i> Reembolsos</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['facturacion.reembolsos.index'], 
...
@section('scripts')
    <script src="{{ url('/js/facturacion/reembolsos.js') }}"></script>
@endsection
