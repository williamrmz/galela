...
@section('FE.EstadoCuenta', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('facturacion.estado-cuenta.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-folder"></i> Estado de Cuenta</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['facturacion.estado-cuenta.index'], 
...
@section('scripts')
    <script src="{{ url('/js/facturacion/estado-cuenta.js') }}"></script>
@endsection
