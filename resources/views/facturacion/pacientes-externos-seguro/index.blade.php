...
@section('FE.PacExtConSeguro', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Facturación</a></li>
<li class='active'>Pacientes Externos con Cuenta (Seguro)</li>
@endsection

@php
	$model = 'pacientesExternosSeguro';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('facturacion.pacientes-externos-seguro.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-folder-open text-orange"></i> Pacientes Externos con Cuenta (Seguro)</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['facturacion.pacientes-externos-seguro.index'], 
...
@section('scripts')
    <script src="{{ url('/js/facturacion/pacientes-externos-seguro.js') }}"></script>
@endsection
