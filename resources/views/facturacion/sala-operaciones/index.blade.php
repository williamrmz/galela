...
@section('FE.FacturacionSalaOperaciones', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Facturación</a></li>
<li class='active'>Sala de Operaciones</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('facturacion.sala-operaciones.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-heartbeat text-red"></i> Sala de Operaciones</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['facturacion.sala-operaciones.index'], 
...
@section('scripts')
    <script src="{{ url('/js/facturacion/sala-operaciones.js') }}"></script>
@endsection
