...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('facturacion.farmacia.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-medkit text-blue"></i> Farmacia</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['facturacion.farmacia.index'], 
...
@section('scripts')
    <script src="{{ url('/js/facturacion/farmacia.js') }}"></script>
@endsection
