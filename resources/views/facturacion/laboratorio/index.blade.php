...
@section('FE.FacturacionPatologiaClinica', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('facturacion.laboratorio.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-tachometer text-light-blue"></i> Laboratorio</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['facturacion.laboratorio.index'], 
...
@section('scripts')
    <script src="{{ url('/js/facturacion/laboratorio.js') }}"></script>
@endsection
