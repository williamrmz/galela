...
@section('FE', 'active menu-open')
@section('FE.PacExtParticular', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Facturación</a></li>
<li class='active'>Pacientes Externos con Cuenta (Particular)</li>
@endsection

@php
	$model = 'pacientesExternosParticular';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('facturacion.pacientes-externos-particular.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-male text-aqua"></i> Pacientes Externos con Cuenta (Particular)</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['facturacion.pacientes-externos-particular.index'], 
...
@section('scripts')
    <script src="{{ url('/js/facturacion/pacientes-externos-particular.js') }}"></script>
@endsection
