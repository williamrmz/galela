...
@section('FE.FacturacionAnatomiaPatologica', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Facturación</a></li>
<li class='active'>Anatomía Patológica</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('facturacion.anatomia-patologica.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-cube text-blue"></i> Anatomía Patológica</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['facturacion.anatomia-patologica.index'], 
...
@section('scripts')
    <script src="{{ url('/js/facturacion/anatomia-patologica.js') }}"></script>
@endsection
