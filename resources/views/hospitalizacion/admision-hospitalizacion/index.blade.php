...
@section('KH', 'active menu-open')
@section('KH.AdmisionHospitalizacion', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Hospitalización</a></li>
<li class='active'>Admisión de hospitalización</li>
@endsection

@php
	$model = 'admisionHospitalizacion';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('hospitalizacion.admision-hospitalizacion.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-folder-open text-green"></i> Admisión de hospitalización</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['hospitalizacion.admision-hospitalizacion.index'], 
...
@section('scripts')
    <script src="{{ url('/js/hospitalizacion/admision-hospitalizacion.js') }}"></script>
@endsection
