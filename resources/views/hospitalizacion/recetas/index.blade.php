...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('hospitalizacion.recetas.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-credit-card text-light-blue"></i> Recetas</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['hospitalizacion.recetas.index'], 
...
@section('scripts')
    <script src="{{ url('/js/hospitalizacion/recetas.js') }}"></script>
@endsection
