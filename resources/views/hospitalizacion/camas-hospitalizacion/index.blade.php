...
@section('KH.CamasHospitalizacion', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Hospitalización</a></li>
<li class='active'>Camas de hospitalización</li>
@endsection

@php
	$model = 'camasHospitalizacion';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('hospitalizacion.camas-hospitalizacion.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-hotel text-blue"></i> Camas de hospitalización</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['hospitalizacion.camas-hospitalizacion.index'], 
...
@section('scripts')
    <script src="{{ url('/js/hospitalizacion/camas-hospitalizacion.js') }}"></script>
@endsection
