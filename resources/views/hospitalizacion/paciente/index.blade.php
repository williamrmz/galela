...
@section('KH.PacienteHosp', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('hospitalizacion.paciente.index')) }}
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['hospitalizacion.paciente.index'], 
...
@section('scripts')
    <script src="{{ url('/js/hospitalizacion/paciente.js') }}"></script>
@endsection
