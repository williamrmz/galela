...
@section('KH.AlojadosHospitalizacion', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Hospitalización</a></li>
<li class='active'>Alojados</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('hospitalizacion.alojados.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa-user text-light-blue"></i> Alojados</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['hospitalizacion.alojados.index'], 
...
@section('scripts')
    <script src="{{ url('/js/hospitalizacion/alojados.js') }}"></script>
@endsection
