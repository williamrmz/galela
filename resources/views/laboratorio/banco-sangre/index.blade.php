...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('laboratorio.banco-sangre.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-support text-red"></i> Banco de Sangre</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['laboratorio.banco-sangre.index'], 
...
@section('scripts')
    <script src="{{ url('/js/laboratorio/banco-sangre.js') }}"></script>
@endsection
