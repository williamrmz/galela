...
@section('LA.OrdenesPatologia', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Laboratorio</a></li>
<li class='active'>Anat. Patológica</li>
@endsection

@php
	$model = 'anatPatologica';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('laboratorio.anat-patologica.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-cube text-blue"></i> Anat. Patológica</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['laboratorio.anat-patologica.index'], 
...
@section('scripts')
    <script src="{{ url('/js/laboratorio/anat-patologica.js') }}"></script>
@endsection
