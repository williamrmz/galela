...
@section('LA.LabIngresos', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Laboratorio</a></li>
<li class='active'>Ingreso Insumos</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('laboratorio.ingreso-insumos.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-exchange"></i> Ingreso Insumos</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['laboratorio.ingreso-insumos.index'], 
...
@section('scripts')
    <script src="{{ url('/js/laboratorio/ingreso-insumos.js') }}"></script>
@endsection
