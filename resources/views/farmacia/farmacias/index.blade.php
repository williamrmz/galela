...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('farmacia.farmacias.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-inbox"></i> Farmacias</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['farmacia.farmacias.index'], 
...
@section('scripts')
    <script src="{{ url('/js/farmacia/farmacias.js') }}"></script>
@endsection
