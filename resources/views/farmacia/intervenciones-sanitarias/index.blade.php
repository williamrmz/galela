...
@section('FA.IntervencionS', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Farmacia</a></li>
<li class='active'>Intervenciones Sanitarias</li>
@endsection

@php
	$model = 'intervencionesSanitarias';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('farmacia.intervenciones-sanitarias.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-folder-open text-purple"></i> Intervenciones Sanitarias</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['farmacia.intervenciones-sanitarias.index'], 
...
@section('scripts')
    <script src="{{ url('/js/farmacia/intervenciones-sanitarias.js') }}"></script>
@endsection
