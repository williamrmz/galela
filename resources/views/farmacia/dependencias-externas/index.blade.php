...
@section('FA.DependenciaExt', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Farmacia</a></li>
<li class='active'>Dependencias Externas</li>
@endsection

@php
	$model = 'dependenciasExternas';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('farmacia.dependencias-externas.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-bank text-light-blue"></i> Dependencias Externas</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['farmacia.dependencias-externas.index'], 
...
@section('scripts')
    <script src="{{ url('/js/farmacia/dependencias-externas.js') }}"></script>
@endsection
