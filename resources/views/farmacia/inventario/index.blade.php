...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('farmacia.inventario.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-cubes text-blue"></i> Inventario</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['farmacia.inventario.index'], 
...
@section('scripts')
    <script src="{{ url('/js/farmacia/inventario.js') }}"></script>
@endsection
