...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('farmacia.venta.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-file-text text-orange"></i> Venta</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['farmacia.venta.index'], 
...
@section('scripts')
    <script src="{{ url('/js/farmacia/venta.js') }}"></script>
@endsection
