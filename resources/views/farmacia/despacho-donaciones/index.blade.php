...
@section('FA.DespachoDonaciones', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Farmacia</a></li>
<li class='active'>Despacho Donaciones</li>
@endsection

@php
	$model = 'despachoDonaciones';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('farmacia.despacho-donaciones.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-file-text-o "></i> Despacho Donaciones</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['farmacia.despacho-donaciones.index'], 
...
@section('scripts')
    <script src="{{ url('/js/farmacia/despacho-donaciones.js') }}"></script>
@endsection
