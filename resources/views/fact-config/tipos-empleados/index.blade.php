...
@section('FC.TiposEmpleado', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Fact - Config</a></li>
<li class='active'>Tipos de Empleado</li>
@endsection

@php
	$model = 'tiposEmpleados';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('fact-config.tipos-empleados.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-group"></i> Tipos de Empleado</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['fact-config.tipos-empleados.index'], 
...
@section('scripts')
    <script src="{{ url('/js/fact-config/tipos-empleados.js') }}"></script>
@endsection
