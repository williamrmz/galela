...
@section('FC.TiposCargo', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Fact - Config</a></li>
<li class='active'>Tipos de Cargo</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('fact-config.tipos-cargo.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa-user text-light-blue"></i> Tipos de Cargo</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['fact-config.tipos-cargo.index'], 
...
@section('scripts')
    <script src="{{ url('/js/fact-config/tipos-cargo.js') }}"></script>
@endsection
