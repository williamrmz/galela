...
@section('FC.TiposEstablecimientos', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Fact - Config</a></li>
<li class='active'>Tipos de Establecimientos</li>
@endsection

@php
	$model = 'tiposEstablecimiento';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('fact-config.tipos-establecimiento.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-circle-o"></i> Tipos de Establecimientos</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['fact-config.tipos-establecimiento.index'], 
...
@section('scripts')
    <script src="{{ url('/js/fact-config/tipos-establecimiento.js') }}"></script>
@endsection
