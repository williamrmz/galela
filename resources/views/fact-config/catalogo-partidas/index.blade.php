...
@section('FC.FacturacionPartidas', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Fact - Config</a></li>
<li class='active'>Catalogo de Partidas</li>
@endsection

@php
	$model = 'catalogoPartidas';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('fact-config.catalogo-partidas.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-list text-yellow"></i> Catalogo de Partidas</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['fact-config.catalogo-partidas.index'], 
...
@section('scripts')
    <script src="{{ url('/js/fact-config/catalogo-partidas.js') }}"></script>
@endsection
