...
@section('FC.ConfiguracionResLab', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Fact - Config</a></li>
<li class='active'>Configuración Resultados de Laboratorio</li>
@endsection

@php
	$model = 'configResultadosLab';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('fact-config.config-resultados-lab.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="glyphicon glyphicon-list-alt text-yellow"></i> Configuración Resultados de Laboratorio</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['fact-config.config-resultados-lab.index'], 
...
@section('scripts')
    <script src="{{ url('/js/fact-config/config-resultados-lab.js') }}"></script>
@endsection
