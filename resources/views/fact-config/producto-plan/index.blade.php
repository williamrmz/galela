...
@section('FC.TiposFinanciamiento', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Fact - Config</a></li>
<li class='active'>Producto/Plan</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('fact-config.producto-plan.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="glyphicon glyphicon-tasks text-purple"></i> Producto/Plan</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['fact-config.producto-plan.index'], 
...
@section('scripts')
    <script src="{{ url('/js/fact-config/producto-plan.js') }}"></script>
@endsection
