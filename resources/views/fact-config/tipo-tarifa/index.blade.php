...
@section('FC.TipoTarifa', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Fact - Config</a></li>
<li class='active'>Tipo Tarifa</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('fact-config.tipo-tarifa.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-files-o"></i> Tipo Tarifa</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['fact-config.tipo-tarifa.index'], 
...
@section('scripts')
    <script src="{{ url('/js/fact-config/tipo-tarifa.js') }}"></script>
@endsection
