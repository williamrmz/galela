...
@section('FC.PqteServicio', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('fact-config.paquetes.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-cubes text-blue"></i> Paquetes</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['fact-config.paquetes.index'], 
...
@section('scripts')
    <script src="{{ url('/js/fact-config/paquetes.js') }}"></script>
@endsection
