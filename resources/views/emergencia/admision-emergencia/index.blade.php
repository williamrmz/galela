...
@section('KE.AdmisionConsultorioEmerg', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Emergencia</a></li>
<li class='active'>Admision de emergencia</li>
@endsection

@php
	$model = 'admisionEmergencia';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('emergencia.admision-emergencia.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-folder-open text-red"></i> Admision de emergencia</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['emergencia.admision-emergencia.index'], 
