...
@section('KE.PacienteEmerg', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('emergencia.paciente.index')) }}
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['emergencia.paciente.index'], 
...
@section('scripts')
    <script src="{{ url('/js/emergencia/paciente.js') }}"></script>
@endsection
