...
@section('KE', 'active menu-open')
@section('KE.CamasEmergencia', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Emergencia</a></li>
<li class='active'>Camas de observación</li>
@endsection

@php
	$model = 'camasObservacion';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('emergencia.camas-observacion.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-hotel text-blue"></i> Camas de observación</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['emergencia.camas-observacion.index'], 
...
@section('scripts')
    <script src="{{ url('/js/emergencia/camas-observacion.js') }}"></script>
@endsection
