...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('emergencia.recetas.index')) }}
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['emergencia.recetas.index'], 
...
@section('scripts')
    <script src="{{ url('/js/emergencia/recetas.js') }}"></script>
@endsection
