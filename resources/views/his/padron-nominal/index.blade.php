...
@section('HI.HisPN', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>HIS</a></li>
<li class='active'>Padrón Nominal</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('his.padron-nominal.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-group"></i> Padrón Nominal</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['his.padron-nominal.index'], 
...
@section('scripts')
    <script src="{{ url('/js/his/padron-nominal.js') }}"></script>
@endsection
