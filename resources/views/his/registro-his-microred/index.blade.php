...
@section('HI.HisCE', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>HIS</a></li>
<li class='active'>Registro HIS de la MicroRed</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('his.registro-his-microred.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="glyphicon glyphicon-list-alt text-purple"></i> Registro HIS de la MicroRed</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['his.registro-his-microred.index'], 
...
@section('scripts')
    <script src="{{ url('/js/his/registro-his-microred.js') }}"></script>
@endsection
