...
@section('HI.HisPMMR', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>HIS</a></li>
<li class='active'>Programación Medica de la MicroRed</li>
@endsection

@php
	$model = 'programacionMedicaMicrored';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('his.programacion-medica-microred.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-calendar text-yellow"></i> Programación Medica de la MicroRed</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['his.programacion-medica-microred.index'], 
...
@section('scripts')
    <script src="{{ url('/js/his/programacion-medica-microred.js') }}"></script>
@endsection
