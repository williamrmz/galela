...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('his.calidad.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-star text-orange"></i> Calidad</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['his.calidad.index'], 
...
@section('scripts')
    <script src="{{ url('/js/his/calidad.js') }}"></script>
@endsection
