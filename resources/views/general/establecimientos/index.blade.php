...
@section('KG.Establecimientos', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('general.establecimientos.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-circle-o"></i> Establecimientos</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['general.establecimientos.index'], 
...
@section('scripts')
    <script src="{{ url('/js/general/establecimientos.js') }}"></script>
@endsection
