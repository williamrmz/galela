...
@section('KG.EstablecimientosNoMinsa', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>General</a></li>
<li class='active'>Establecimientos No MINSA</li>
@endsection

@php
	$model = 'establecimientosNoMinsa';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('general.establecimientos-no-minsa.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-bank text-purple"></i> Establecimientos No MINSA</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['general.establecimientos-no-minsa.index'], 
...
@section('scripts')
    <script src="{{ url('/js/general/establecimientos-no-minsa.js') }}"></script>
@endsection
