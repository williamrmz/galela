...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('general.servicios.index')) }}
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['general.servicios.index'], 
...
@section('scripts')
    <script src="{{ url('/js/general/servicios.js') }}"></script>
@endsection
