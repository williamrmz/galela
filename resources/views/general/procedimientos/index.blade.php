...
@section('KG.Procedimientos', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('general.procedimientos.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-life-bouy text-red"></i> Procedimientos</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['general.procedimientos.index'], 
...
@section('scripts')
    <script src="{{ url('/js/general/procedimientos.js') }}"></script>
@endsection
