...
@section('KG.Diagnosticos', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('general.diagnosticos.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-safari"></i> Diagnósticos</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['general.diagnosticos.index'], 
...
@section('scripts')
    <script src="{{ url('/js/general/diagnosticos.js') }}"></script>
@endsection
