...
@section('KG.DiagnosticosPDF', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>General</a></li>
<li class='active'>Diagnosticos PDF</li>
@endsection

@php
	$model = 'diagnosticosPdf';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('general.diagnosticos-pdf.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-file-pdf-o"></i> Diagnosticos PDF</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['general.diagnosticos-pdf.index'], 
...
@section('scripts')
    <script src="{{ url('/js/general/diagnosticos-pdf.js') }}"></script>
@endsection
