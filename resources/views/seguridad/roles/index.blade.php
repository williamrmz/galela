...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('seguridad.roles.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-group text-purple"></i> Roles</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['seguridad.roles.index'], 
...
@section('scripts')
    <script src="{{ url('/js/seguridad/roles.js') }}"></script>
@endsection
