...
{{  Form::open(['route' => ['seguridad.roles.update', $item->IdRol], 'method'=>'PUT', 'id'=>$model.'-form']) }}
	<div class="row">
							...
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-md-1 col-sm-12">
										<div class="checkbox">
											<label><input type="checkbox" class="chk-modulo-agregar">agregar</label>
										</div>
									</div>
									<div class="col-md-1 col-sm-12">
										<div class="checkbox">
											<label><input type="checkbox" class="chk-modulo-modificar">modificar</label>
										</div>	
									</div>
									<div class="col-md-1 col-sm-12">
										<div class="checkbox">
											<label><input type="checkbox" class="chk-modulo-consultar">consultar</label>
										</div>
									</div>
									<div class="col-md-1 col-sm-12">
										<div class="checkbox">
											<label><input type="checkbox" class="chk-modulo-eliminar">eliminar</label>
										</div>
									</div>
									<div class="col-md-2 col-sm-12">
										<a href="#" class="btn btn-sm btn-default btn-block btn-agregar-modulo"> <i class="fa fa-plus"></i> ADD </a>
									</div>
								</div>
							</div>
							<div class="col-sm-12">
							...
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-md-2 col-sm-12 col-md-offset-4">
										<a href="#" class="btn btn-sm btn-default btn-block btn-agregar-permiso"> <i class="fa fa-plus"></i> ADD </a>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-md-2 col-sm-12">
										<div class="checkbox">
											<label><input type="checkbox" class="chk-reporte-todos">Todos</label>
										</div>
									</div>
									<div class="col-md-2 col-sm-12">
										<div class="checkbox">
											<label><input type="checkbox" class="chk-reporte-ninguno">Ninguno</label>
										</div>	
									</div>
									<div class="col-md-2 col-sm-12">
										<a href="#" class="btn btn-sm btn-default btn-block btn-agregar-reporte"> <i class="fa fa-plus"></i> ADD </a>
									</div>
								</div>
							</div>
							<div class="col-sm-12">
		...
		<div class="col-sm-12">
			<div class="pull-right">
				...
				<button type="submit" class="btn btn-sm btn-success {{$model}}-btn-update">MODIFICAR</button>
			</div>
		</div>
	</div>
{{ Form::close() }}