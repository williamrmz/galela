...
{{  Form::open(['route' => ['seguridad.empleados.store'], 'method'=>'POST', 'id'=>$model.'-form', 'autocomplete'=>'off']) }}
	<div class="row">
		<div class="col-sm-12">
							...
							<div class="box box-primary">
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-sm-7"> {{ Form::text('usuario', null, ['class'=>'form-control input-sm', 'autocomplete'=>'off']) }} </div>

										<div class="col-sm-5"> {{ Form::label('clave', 'Clave') }}</div>
										<div class="col-sm-7"> {{ Form::password('clave',  ['class'=>'form-control input-sm']) }} </div>

										<div class="col-sm-5"> {{ Form::label('codigoDigitador', 'Esta usando Galenhos') }}</div>
										<div class="col-sm-7">
											<div class="input-group">
												<span class="input-group-addon"> {{ Form::checkbox('usaGalenhos', 1, false)}} </span>
												{{ Form::text('loginPc', null, ['class'=>'form-control input-sm','disabled']) }}
											</div>
										</div>
