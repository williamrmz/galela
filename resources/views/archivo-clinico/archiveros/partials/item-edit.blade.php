...
{{  Form::open(['route' => ['archivo-clinico.archiveros.update', 0], 'method'=>'PUT', 'id'=>$model.'-form']) }}
		...
		<div class="box-body" >
			<div class="row">
				...
				<div class="col-sm-12 form-group">
					<div class="row">
						<div class="col-sm-3">
							<a href="" class="btn btn-sm btn-block btn-default btn-archivero"> Archivero <i class="fa fa-search"></i></a>
						</div>
						<div class="col-sm-3">
				...
				<div class="col-sm-12 form-group">
					<div class="row">
						<div class="col-sm-3">
							<a href="" class="btn btn-sm btn-block btn-default btn-servicio"> Servicio <i class="fa fa-search"></i></a>
						</div>
						<div class="col-sm-3">
						...
						<div class="col-sm-6">
							<div class="input-group">
								...
								<a href="#" class="input-group-addon btn-agregar-servicio"> <i class="fa fa-plus"></i></a>
							</div>
