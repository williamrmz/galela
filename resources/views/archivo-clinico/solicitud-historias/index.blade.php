...
@section('KA.SolicitudHistorias', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Archivo Clinico</a></li>
<li class='active'>Solicitud de historias</li>
@endsection

@php
	$model = 'solicitudHistorias';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('archivo-clinico.solicitud-historias.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-file-text-o "></i> Solicitud de historias</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['archivo-clinico.solicitud-historias.index'], 
...
@section('scripts')
    <script src="{{ url('/js/archivo-clinico/solicitud-historias.js') }}"></script>
@endsection
