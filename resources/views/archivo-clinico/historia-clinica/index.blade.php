...
@section('KA.HistoriaClinica', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('archivo-clinico.historia-clinica.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-tasks text-aqua"></i> Historia Clínica</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['archivo-clinico.historia-clinica.index'], 
...
@section('scripts')
    <script src="{{ url('/js/archivo-clinico/historia-clinica.js') }}"></script>
@endsection
