...
{{-- variables sunasa --}}
{{ Form::hidden('idSunasaPacienteHistorico', null, ['id'=>'idSunasaPacienteHistorico' ]) }}
{{ Form::hidden('yaNoTieneSeguroUltimoRegistroGrabado', null, ['id'=>'yaNoTieneSeguroUltimoRegistroGrabado' ]) }}

<div class="row" id="partial-crud" style="display: none">
	<div class="col-sm-12">
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs" id="myTabs">
				<li class="active"><a href="#tab_paciente" role="tab" data-toggle="tab">1.1) Datos del paciente</a></li>
				<li><a href="#tab_sunasa" role="tab" data-toggle="tab">1.2) SUNASA</a></li>
			</ul>
			<div class="tab-content" style="padding-bottom:40px;">

				<div class="tab-pane active" id="tab_paciente" role="tabpanel">
				...
				<!-- /.tab-pane -->
				<div class="tab-pane" id="tab_sunasa" role="tabpanel">
					<div class="row">
						{{-- Info general --}}
						<div class="col-sm-12">
							<div class="row">
