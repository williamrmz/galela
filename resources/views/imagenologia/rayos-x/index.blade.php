...
@section('IM.ImagRayosX', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Imagenología</a></li>
<li class='active'>Rayos X</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('imagenologia.rayos-x.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-tv text-yellow"></i> Rayos X</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['imagenologia.rayos-x.index'], 
...
@section('scripts')
    <script src="{{ url('/js/imagenologia/rayos-x.js') }}"></script>
@endsection
