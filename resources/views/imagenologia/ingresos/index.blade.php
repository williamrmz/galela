...
@section('IM.ImagIngresos', 'active')
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('imagenologia.ingresos.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="glyphicon glyphicon-copy text-green"></i> Ingresos</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['imagenologia.ingresos.index'], 
...
@section('scripts')
    <script src="{{ url('/js/imagenologia/ingresos.js') }}"></script>
@endsection
