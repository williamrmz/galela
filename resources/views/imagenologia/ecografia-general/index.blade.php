...
@section('IM.ImagEcografiaG', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Imagenología</a></li>
<li class='active'>Ecografía General</li>
@endsection

@php
	$model = 'ecografiaGeneral';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('imagenologia.ecografia-general.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-credit-card text-light-blue"></i> Ecografía General</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['imagenologia.ecografia-general.index'], 
...
@section('scripts')
    <script src="{{ url('/js/imagenologia/ecografia-general.js') }}"></script>
@endsection
