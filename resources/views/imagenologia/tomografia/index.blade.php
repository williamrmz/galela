...
@section('IM.ImagTomografia', 'active')

@section('breadcrumb')
<li><a href='#'>Inicio</a></li>
<li><a href='#'>Imagenología</a></li>
<li class='active'>Tomografía</li>
@endsection
...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('imagenologia.tomografia.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="glyphicon glyphicon-list-alt text-purple"></i> Tomografía</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['imagenologia.tomografia.index'], 
...
@section('scripts')
    <script src="{{ url('/js/imagenologia/tomografia.js') }}"></script>
@endsection
