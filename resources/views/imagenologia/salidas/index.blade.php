...
@section('content')
	...
	{{ Form::hidden($model.'-path-ctrl', route('imagenologia.salidas.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="glyphicon glyphicon-paste"></i> Salidas</h3>
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-sm-12">
							{{ Form::open(['route' => ['imagenologia.salidas.index'], 
...
@section('scripts')
    <script src="{{ url('/js/imagenologia/salidas.js') }}"></script>
@endsection
