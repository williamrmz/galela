...
@php
	$model = 'profesionalesSalud';
@endphp

@section('content')

	{{ Form::hidden($model.'-path-ctrl', route('programacion-general.profesionales-salud.index')) }}
		...
		<div class='col-sm-12'>
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-user-md text-green"></i> Profesionales de la Salud</h3>
...
@section('scripts')
    <script src="{{ url('/js/programacion-general/profesionales-salud.js') }}"></script>
@endsection
