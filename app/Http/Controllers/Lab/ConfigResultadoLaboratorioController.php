...
class ConfigResultadoLaboratorioController extends Controller
{
    public function index(Request $request)
    {
        ...
        if(request()->ajax()){
            ...
            return view('lab.insumos.config-resultados-laboratorio.partials.list', compact('grupos'));
        }
        
        return view('lab.insumos.config-resultados-laboratorio.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('lab.insumos.config-resultados-laboratorio.edit', compact('servicio', 'itemsCPT'));
    }
